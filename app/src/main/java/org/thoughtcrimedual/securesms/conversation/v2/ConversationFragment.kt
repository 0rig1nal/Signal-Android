...
import org.thoughtcrimedual.securesms.BlockUnblockDialog
import org.thoughtcrimedual.securesms.GroupMembersDialog
import org.thoughtcrimedual.securesms.LoggingFragment
import org.thoughtcrimedual.securesms.MainActivity
import org.thoughtcrimedual.securesms.MuteDialog
import org.thoughtcrimedual.securesms.R
import org.thoughtcrimedual.securesms.audio.AudioRecorder
import org.thoughtcrimedual.securesms.badges.gifts.OpenableGift
import org.thoughtcrimedual.securesms.badges.gifts.OpenableGiftItemDecoration
import org.thoughtcrimedual.securesms.badges.gifts.viewgift.received.ViewReceivedGiftBottomSheet
import org.thoughtcrimedual.securesms.badges.gifts.viewgift.sent.ViewSentGiftBottomSheet
import org.thoughtcrimedual.securesms.calls.YouAreAlreadyInACallSnackbar
import org.thoughtcrimedual.securesms.components.AnimatingToggle
import org.thoughtcrimedual.securesms.components.ComposeText
import org.thoughtcrimedual.securesms.components.ConversationSearchBottomBar
import org.thoughtcrimedual.securesms.components.DeleteSyncEducationDialog
import org.thoughtcrimedual.securesms.components.HidingLinearLayout
import org.thoughtcrimedual.securesms.components.InputAwareConstraintLayout
import org.thoughtcrimedual.securesms.components.InputPanel
import org.thoughtcrimedual.securesms.components.InsetAwareConstraintLayout
import org.thoughtcrimedual.securesms.components.ProgressCardDialogFragment
import org.thoughtcrimedual.securesms.components.ProgressCardDialogFragmentArgs
import org.thoughtcrimedual.securesms.components.ScrollToPositionDelegate
import org.thoughtcrimedual.securesms.components.SendButton
...
import org.thoughtcrimedual.securesms.components.emoji.MediaKeyboard
import org.thoughtcrimedual.securesms.components.emoji.RecentEmojiPageModel
import org.thoughtcrimedual.securesms.components.location.SignalPlace
import org.thoughtcrimedual.securesms.components.mention.MentionAnnotation
import org.thoughtcrimedual.securesms.components.menu.ActionItem
import org.thoughtcrimedual.securesms.components.menu.SignalBottomActionBar
import org.thoughtcrimedual.securesms.components.settings.app.subscription.donate.CheckoutFlowActivity
import org.thoughtcrimedual.securesms.components.settings.app.subscription.donate.DonateToSignalFragment
import org.thoughtcrimedual.securesms.components.settings.conversation.ConversationSettingsActivity
import org.thoughtcrimedual.securesms.components.spoiler.SpoilerAnnotation
import org.thoughtcrimedual.securesms.components.voice.VoiceNoteDraft
import org.thoughtcrimedual.securesms.components.voice.VoiceNoteMediaControllerOwner
import org.thoughtcrimedual.securesms.components.voice.VoiceNotePlaybackState
import org.thoughtcrimedual.securesms.components.voice.VoiceNotePlayerView
import org.thoughtcrimedual.securesms.contacts.paged.ContactSearchKey.RecipientSearchKey
import org.thoughtcrimedual.securesms.contactshare.Contact
import org.thoughtcrimedual.securesms.contactshare.ContactUtil
import org.thoughtcrimedual.securesms.contactshare.SharedContactDetailsActivity
import org.thoughtcrimedual.securesms.conversation.AttachmentKeyboardButton
import org.thoughtcrimedual.securesms.conversation.BadDecryptLearnMoreDialog
import org.thoughtcrimedual.securesms.conversation.ConversationAdapter
import org.thoughtcrimedual.securesms.conversation.ConversationBottomSheetCallback
import org.thoughtcrimedual.securesms.conversation.ConversationData
import org.thoughtcrimedual.securesms.conversation.ConversationHeaderView
import org.thoughtcrimedual.securesms.conversation.ConversationIntents
import org.thoughtcrimedual.securesms.conversation.ConversationIntents.ConversationScreenType
import org.thoughtcrimedual.securesms.conversation.ConversationItem
import org.thoughtcrimedual.securesms.conversation.ConversationItemSelection
import org.thoughtcrimedual.securesms.conversation.ConversationItemSwipeCallback
import org.thoughtcrimedual.securesms.conversation.ConversationMessage
import org.thoughtcrimedual.securesms.conversation.ConversationOptionsMenu
import org.thoughtcrimedual.securesms.conversation.ConversationReactionDelegate
import org.thoughtcrimedual.securesms.conversation.ConversationReactionOverlay
import org.thoughtcrimedual.securesms.conversation.ConversationReactionOverlay.OnActionSelectedListener
import org.thoughtcrimedual.securesms.conversation.ConversationReactionOverlay.OnHideListener
import org.thoughtcrimedual.securesms.conversation.ConversationSearchViewModel
import org.thoughtcrimedual.securesms.conversation.ConversationUpdateTick
import org.thoughtcrimedual.securesms.conversation.MarkReadHelper
import org.thoughtcrimedual.securesms.conversation.MenuState
import org.thoughtcrimedual.securesms.conversation.MessageSendType
import org.thoughtcrimedual.securesms.conversation.MessageStyler.getStyling
import org.thoughtcrimedual.securesms.conversation.ReenableScheduledMessagesDialogFragment
import org.thoughtcrimedual.securesms.conversation.ScheduleMessageContextMenu
import org.thoughtcrimedual.securesms.conversation.ScheduleMessageDialogCallback
import org.thoughtcrimedual.securesms.conversation.ScheduleMessageTimePickerBottomSheet
import org.thoughtcrimedual.securesms.conversation.ScheduleMessageTimePickerBottomSheet.Companion.showSchedule
import org.thoughtcrimedual.securesms.conversation.ScheduledMessagesBottomSheet
import org.thoughtcrimedual.securesms.conversation.ScheduledMessagesRepository
import org.thoughtcrimedual.securesms.conversation.SelectedConversationModel
import org.thoughtcrimedual.securesms.conversation.ShowAdminsBottomSheetDialog
...
import org.thoughtcrimedual.securesms.conversation.colors.RecyclerViewColorizer
import org.thoughtcrimedual.securesms.conversation.drafts.DraftRepository
import org.thoughtcrimedual.securesms.conversation.drafts.DraftRepository.ShareOrDraftData
import org.thoughtcrimedual.securesms.conversation.drafts.DraftViewModel
import org.thoughtcrimedual.securesms.conversation.mutiselect.ConversationItemAnimator
import org.thoughtcrimedual.securesms.conversation.mutiselect.MultiselectItemDecoration
import org.thoughtcrimedual.securesms.conversation.mutiselect.MultiselectPart
import org.thoughtcrimedual.securesms.conversation.mutiselect.forward.MultiselectForwardBottomSheet
...
import org.thoughtcrimedual.securesms.conversation.quotes.MessageQuotesBottomSheet
import org.thoughtcrimedual.securesms.conversation.ui.edit.EditMessageHistoryDialog
import org.thoughtcrimedual.securesms.conversation.ui.error.EnableCallNotificationSettingsDialog
import org.thoughtcrimedual.securesms.conversation.ui.inlinequery.InlineQuery
import org.thoughtcrimedual.securesms.conversation.ui.inlinequery.InlineQueryChangedListener
import org.thoughtcrimedual.securesms.conversation.ui.inlinequery.InlineQueryReplacement
import org.thoughtcrimedual.securesms.conversation.ui.inlinequery.InlineQueryResultsControllerV2
import org.thoughtcrimedual.securesms.conversation.ui.inlinequery.InlineQueryViewModelV2
import org.thoughtcrimedual.securesms.conversation.v2.computed.ConversationMessageComputeWorkers
import org.thoughtcrimedual.securesms.conversation.v2.data.ConversationMessageElement
import org.thoughtcrimedual.securesms.conversation.v2.groups.ConversationGroupCallViewModel
import org.thoughtcrimedual.securesms.conversation.v2.groups.ConversationGroupViewModel
import org.thoughtcrimedual.securesms.conversation.v2.items.ChatColorsDrawable
import org.thoughtcrimedual.securesms.conversation.v2.items.InteractiveConversationElement
import org.thoughtcrimedual.securesms.conversation.v2.keyboard.AttachmentKeyboardFragment
import org.thoughtcrimedual.securesms.database.AttachmentTable
import org.thoughtcrimedual.securesms.database.DraftTable
...
import org.thoughtcrimedual.securesms.database.model.Quote
...
import org.thoughtcrimedual.securesms.databinding.V2ConversationFragmentBinding
import org.thoughtcrimedual.securesms.dependencies.AppDependencies
import org.thoughtcrimedual.securesms.events.GroupCallPeekEvent
import org.thoughtcrimedual.securesms.giph.mp4.GiphyMp4ItemDecoration
import org.thoughtcrimedual.securesms.giph.mp4.GiphyMp4PlaybackController
import org.thoughtcrimedual.securesms.giph.mp4.GiphyMp4PlaybackPolicy
import org.thoughtcrimedual.securesms.giph.mp4.GiphyMp4ProjectionPlayerHolder
import org.thoughtcrimedual.securesms.giph.mp4.GiphyMp4ProjectionRecycler
...
import org.thoughtcrimedual.securesms.groups.ui.GroupErrors
import org.thoughtcrimedual.securesms.groups.ui.LeaveGroupDialog
import org.thoughtcrimedual.securesms.groups.ui.invitesandrequests.ManagePendingAndRequestingMembersActivity
import org.thoughtcrimedual.securesms.groups.ui.invitesandrequests.invite.GroupLinkInviteFriendsBottomSheetDialogFragment
import org.thoughtcrimedual.securesms.groups.ui.managegroup.dialogs.GroupDescriptionDialog
import org.thoughtcrimedual.securesms.groups.ui.migration.GroupsV1MigrationInfoBottomSheetDialogFragment
import org.thoughtcrimedual.securesms.groups.ui.migration.GroupsV1MigrationSuggestionsDialog
import org.thoughtcrimedual.securesms.groups.v2.GroupBlockJoinRequestResult
import org.thoughtcrimedual.securesms.invites.InviteActions
import org.thoughtcrimedual.securesms.jobs.ServiceOutageDetectionJob
import org.thoughtcrimedual.securesms.keyboard.KeyboardPage
import org.thoughtcrimedual.securesms.keyboard.KeyboardPagerFragment
import org.thoughtcrimedual.securesms.keyboard.KeyboardPagerViewModel
import org.thoughtcrimedual.securesms.keyboard.KeyboardUtil
import org.thoughtcrimedual.securesms.keyboard.emoji.EmojiKeyboardPageFragment
import org.thoughtcrimedual.securesms.keyboard.emoji.search.EmojiSearchFragment
import org.thoughtcrimedual.securesms.keyboard.gif.GifKeyboardPageFragment
import org.thoughtcrimedual.securesms.keyboard.sticker.StickerKeyboardPageFragment
import org.thoughtcrimedual.securesms.keyboard.sticker.StickerSearchDialogFragment
import org.thoughtcrimedual.securesms.keyvalue.SignalStore
import org.thoughtcrimedual.securesms.linkpreview.LinkPreview
import org.thoughtcrimedual.securesms.linkpreview.LinkPreviewViewModelV2
import org.thoughtcrimedual.securesms.longmessage.LongMessageFragment
import org.thoughtcrimedual.securesms.mediaoverview.MediaOverviewActivity
import org.thoughtcrimedual.securesms.mediapreview.MediaIntentFactory
import org.thoughtcrimedual.securesms.mediapreview.MediaPreviewV2Activity
import org.thoughtcrimedual.securesms.mediasend.Media
import org.thoughtcrimedual.securesms.mediasend.MediaSendActivityResult
import org.thoughtcrimedual.securesms.messagedetails.MessageDetailsFragment
import org.thoughtcrimedual.securesms.messagerequests.MessageRequestRepository
import org.thoughtcrimedual.securesms.mms.AttachmentManager
import org.thoughtcrimedual.securesms.mms.AudioSlide
import org.thoughtcrimedual.securesms.mms.DocumentSlide
import org.thoughtcrimedual.securesms.mms.GifSlide
import org.thoughtcrimedual.securesms.mms.ImageSlide
import org.thoughtcrimedual.securesms.mms.MediaConstraints
import org.thoughtcrimedual.securesms.mms.QuoteModel
import org.thoughtcrimedual.securesms.mms.Slide
import org.thoughtcrimedual.securesms.mms.SlideDeck
import org.thoughtcrimedual.securesms.mms.SlideFactory
import org.thoughtcrimedual.securesms.mms.StickerSlide
import org.thoughtcrimedual.securesms.mms.VideoSlide
import org.thoughtcrimedual.securesms.nicknames.NicknameActivity
import org.thoughtcrimedual.securesms.notifications.v2.ConversationId
import org.thoughtcrimedual.securesms.payments.preferences.PaymentsActivity
import org.thoughtcrimedual.securesms.permissions.Permissions
import org.thoughtcrimedual.securesms.profiles.manage.EditProfileActivity
import org.thoughtcrimedual.securesms.profiles.spoofing.ReviewCardDialogFragment
import org.thoughtcrimedual.securesms.providers.BlobProvider
import org.thoughtcrimedual.securesms.ratelimit.RecaptchaProofBottomSheetFragment
import org.thoughtcrimedual.securesms.ratelimit.RecaptchaRequiredEvent
import org.thoughtcrimedual.securesms.reactions.ReactionsBottomSheetDialogFragment
import org.thoughtcrimedual.securesms.reactions.any.ReactWithAnyEmojiBottomSheetDialogFragment
import org.thoughtcrimedual.securesms.recipients.Recipient
import org.thoughtcrimedual.securesms.recipients.RecipientExporter
import org.thoughtcrimedual.securesms.recipients.RecipientId
import org.thoughtcrimedual.securesms.recipients.ui.bottomsheet.RecipientBottomSheetDialogFragment
import org.thoughtcrimedual.securesms.recipients.ui.disappearingmessages.RecipientDisappearingMessagesActivity
import org.thoughtcrimedual.securesms.registration.ui.RegistrationActivity
import org.thoughtcrimedual.securesms.revealable.ViewOnceMessageActivity
import org.thoughtcrimedual.securesms.revealable.ViewOnceUtil
...
import org.thoughtcrimedual.securesms.stickers.StickerEventListener
import org.thoughtcrimedual.securesms.stickers.StickerLocator
import org.thoughtcrimedual.securesms.stickers.StickerManagementActivity
import org.thoughtcrimedual.securesms.stickers.StickerPackInstallEvent
import org.thoughtcrimedual.securesms.stickers.StickerPackPreviewActivity
...
import org.thoughtcrimedual.securesms.util.BubbleUtil
import org.thoughtcrimedual.securesms.util.CommunicationActions
import org.thoughtcrimedual.securesms.util.ContextUtil
import org.thoughtcrimedual.securesms.util.ConversationUtil
import org.thoughtcrimedual.securesms.util.DateUtils
import org.thoughtcrimedual.securesms.util.Debouncer
import org.thoughtcrimedual.securesms.util.DeleteDialog
import org.thoughtcrimedual.securesms.util.Dialogs
import org.thoughtcrimedual.securesms.util.DoubleClickDebouncer
import org.thoughtcrimedual.securesms.util.DrawableUtil
import org.thoughtcrimedual.securesms.util.FullscreenHelper
import org.thoughtcrimedual.securesms.util.MediaUtil
import org.thoughtcrimedual.securesms.util.MessageConstraintsUtil
import org.thoughtcrimedual.securesms.util.MessageConstraintsUtil.getEditMessageThresholdHours
import org.thoughtcrimedual.securesms.util.MessageConstraintsUtil.isValidEditMessageSend
import org.thoughtcrimedual.securesms.util.PlayStoreUtil
import org.thoughtcrimedual.securesms.util.RemoteConfig
import org.thoughtcrimedual.securesms.util.SaveAttachmentUtil
import org.thoughtcrimedual.securesms.util.SignalLocalMetrics
import org.thoughtcrimedual.securesms.util.StorageUtil
import org.thoughtcrimedual.securesms.util.TextSecurePreferences
import org.thoughtcrimedual.securesms.util.ViewUtil
import org.thoughtcrimedual.securesms.util.WindowUtil
import org.thoughtcrimedual.securesms.util.atMidnight
import org.thoughtcrimedual.securesms.util.atUTC
import org.thoughtcrimedual.securesms.util.createActivityViewModel
import org.thoughtcrimedual.securesms.util.doAfterNextLayout
import org.thoughtcrimedual.securesms.util.fragments.requireListener
import org.thoughtcrimedual.securesms.util.getRecordQuoteType
import org.thoughtcrimedual.securesms.util.hasAudio
import org.thoughtcrimedual.securesms.util.hasGiftBadge
import org.thoughtcrimedual.securesms.util.hasNonTextSlide
import org.thoughtcrimedual.securesms.util.isValidReactionTarget
import org.thoughtcrimedual.securesms.util.padding
import org.thoughtcrimedual.securesms.util.savedStateViewModel
import org.thoughtcrimedual.securesms.util.setIncognitoKeyboardEnabled
import org.thoughtcrimedual.securesms.util.toMillis
import org.thoughtcrimedual.securesms.util.viewModel
import org.thoughtcrimedual.securesms.util.views.Stub
import org.thoughtcrimedual.securesms.util.visible
import org.thoughtcrimedual.securesms.verify.VerifyIdentityActivity
import org.thoughtcrimedual.securesms.wallpaper.ChatWallpaper
import org.thoughtcrimedual.securesms.wallpaper.ChatWallpaperDimLevelUtil
