...
class MiscellaneousValues internal constructor(store: KeyValueStore) : SignalStoreValues(store) {
  ...
  /**
   * The last time we ran an account consistency check via [org.thoughtcrimedual.securesms.jobs.AccountConsistencyWorkerJob]
   */
  ...
  /**
   * The last time we prompted the user regarding a [org.thoughtcrimedual.securesms.util.ConnectivityWarning].
   */
