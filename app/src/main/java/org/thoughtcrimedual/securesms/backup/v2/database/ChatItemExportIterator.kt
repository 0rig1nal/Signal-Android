...
import org.thoughtcrimedual.securesms.backup.v2.proto.ChatItem
import org.thoughtcrimedual.securesms.backup.v2.proto.ChatUpdateMessage
import org.thoughtcrimedual.securesms.backup.v2.proto.ContactAttachment
import org.thoughtcrimedual.securesms.backup.v2.proto.ContactMessage
import org.thoughtcrimedual.securesms.backup.v2.proto.ExpirationTimerChatUpdate
import org.thoughtcrimedual.securesms.backup.v2.proto.GroupCall
import org.thoughtcrimedual.securesms.backup.v2.proto.IndividualCall
import org.thoughtcrimedual.securesms.backup.v2.proto.LearnedProfileChatUpdate
import org.thoughtcrimedual.securesms.backup.v2.proto.MessageAttachment
import org.thoughtcrimedual.securesms.backup.v2.proto.PaymentNotification
import org.thoughtcrimedual.securesms.backup.v2.proto.ProfileChangeChatUpdate
import org.thoughtcrimedual.securesms.backup.v2.proto.Quote
import org.thoughtcrimedual.securesms.backup.v2.proto.Reaction
import org.thoughtcrimedual.securesms.backup.v2.proto.RemoteDeletedMessage
import org.thoughtcrimedual.securesms.backup.v2.proto.SendStatus
import org.thoughtcrimedual.securesms.backup.v2.proto.SessionSwitchoverChatUpdate
import org.thoughtcrimedual.securesms.backup.v2.proto.SimpleChatUpdate
import org.thoughtcrimedual.securesms.backup.v2.proto.StandardMessage
import org.thoughtcrimedual.securesms.backup.v2.proto.Sticker
import org.thoughtcrimedual.securesms.backup.v2.proto.StickerMessage
import org.thoughtcrimedual.securesms.backup.v2.proto.Text
import org.thoughtcrimedual.securesms.backup.v2.proto.ThreadMergeChatUpdate
import org.thoughtcrimedual.securesms.backup.v2.util.toRemoteFilePointer
...
import org.thoughtcrimedual.securesms.database.model.GroupsV2UpdateMessageConverter
...
import org.thoughtcrimedual.securesms.database.model.databaseprotos.DecryptedGroupV2Context
...
import org.thoughtcrimedual.securesms.payments.FailureReason
import org.thoughtcrimedual.securesms.payments.State
import org.thoughtcrimedual.securesms.payments.proto.PaymentMetaData
...
import org.thoughtcrimedual.securesms.backup.v2.proto.BodyRange as BackupBodyRange
import org.thoughtcrimedual.securesms.backup.v2.proto.GiftBadge as BackupGiftBadge
...
class ChatItemExportIterator(private val cursor: Cursor, private val batchSize: Int, private val mediaArchiveEnabled: Boolean) : Iterator<ChatItem?>, Closeable {
  ...
  private fun LinkPreview.toBackupLinkPreview(): org.thoughtcrimedual.securesms.backup.v2.proto.LinkPreview {
    return org.thoughtcrimedual.securesms.backup.v2.proto.LinkPreview(
      url = url,
      title = title,
