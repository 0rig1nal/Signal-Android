...
import org.thoughtcrimedual.securesms.backup.v2.proto.BodyRange
...
import org.thoughtcrimedual.securesms.backup.v2.proto.LinkPreview
...
import org.thoughtcrimedual.securesms.backup.v2.util.toLocalAttachment
...
import org.thoughtcrimedual.securesms.database.ReactionTable
...
import org.thoughtcrimedual.securesms.database.model.databaseprotos.CryptoValue
import org.thoughtcrimedual.securesms.database.model.databaseprotos.GV2UpdateDescription
...
import org.thoughtcrimedual.securesms.database.model.databaseprotos.PaymentTombstone
...
import org.thoughtcrimedual.securesms.payments.CryptoValueUtil
import org.thoughtcrimedual.securesms.payments.Direction
...
import org.thoughtcrimedual.securesms.profiles.ProfileName
...
class ChatItemImportInserter(
  ...
  private fun LinkPreview.toLocalLinkPreview(): org.thoughtcrimedual.securesms.linkpreview.LinkPreview {
    return org.thoughtcrimedual.securesms.linkpreview.LinkPreview(
      this.url,
      this.title ?: "",
      this.description ?: "",
      this.date ?: 0,
