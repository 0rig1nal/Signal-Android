...
import org.thoughtcrimedual.securesms.jobs.SendRetryReceiptJob
...
object MessageDecryptor {
   ...
   * These can vary from enqueueing jobs to inserting items into the [org.thoughtcrimedual.securesms.database.PendingRetryReceiptCache].
   */
  fun decrypt(
    context: Context,
