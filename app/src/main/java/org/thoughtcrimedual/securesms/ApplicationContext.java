...
import org.thoughtcrimedual.securesms.apkupdate.ApkUpdateRefreshListener;
import org.thoughtcrimedual.securesms.avatar.AvatarPickerStorage;
import org.thoughtcrimedual.securesms.crypto.AttachmentSecretProvider;
import org.thoughtcrimedual.securesms.crypto.DatabaseSecretProvider;
import org.thoughtcrimedual.securesms.database.LogDatabase;
import org.thoughtcrimedual.securesms.database.SignalDatabase;
import org.thoughtcrimedual.securesms.database.SqlCipherLibraryLoader;
import org.thoughtcrimedual.securesms.dependencies.AppDependencies;
import org.thoughtcrimedual.securesms.dependencies.ApplicationDependencyProvider;
import org.thoughtcrimedual.securesms.emoji.EmojiSource;
import org.thoughtcrimedual.securesms.emoji.JumboEmoji;
import org.thoughtcrimedual.securesms.gcm.FcmFetchManager;
import org.thoughtcrimedual.securesms.jobs.AccountConsistencyWorkerJob;
import org.thoughtcrimedual.securesms.jobs.BuildExpirationConfirmationJob;
import org.thoughtcrimedual.securesms.jobs.CheckServiceReachabilityJob;
import org.thoughtcrimedual.securesms.jobs.DownloadLatestEmojiDataJob;
import org.thoughtcrimedual.securesms.jobs.EmojiSearchIndexDownloadJob;
import org.thoughtcrimedual.securesms.jobs.FcmRefreshJob;
import org.thoughtcrimedual.securesms.jobs.FontDownloaderJob;
import org.thoughtcrimedual.securesms.jobs.GroupRingCleanupJob;
import org.thoughtcrimedual.securesms.jobs.GroupV2UpdateSelfProfileKeyJob;
import org.thoughtcrimedual.securesms.jobs.InAppPaymentAuthCheckJob;
import org.thoughtcrimedual.securesms.jobs.InAppPaymentKeepAliveJob;
import org.thoughtcrimedual.securesms.jobs.LinkedDeviceInactiveCheckJob;
import org.thoughtcrimedual.securesms.jobs.MultiDeviceContactUpdateJob;
import org.thoughtcrimedual.securesms.jobs.PnpInitializeDevicesJob;
import org.thoughtcrimedual.securesms.jobs.PreKeysSyncJob;
import org.thoughtcrimedual.securesms.jobs.ProfileUploadJob;
import org.thoughtcrimedual.securesms.jobs.RefreshSvrCredentialsJob;
import org.thoughtcrimedual.securesms.jobs.RetrieveProfileJob;
import org.thoughtcrimedual.securesms.jobs.RetrieveRemoteAnnouncementsJob;
import org.thoughtcrimedual.securesms.jobs.StoryOnboardingDownloadJob;
import org.thoughtcrimedual.securesms.keyvalue.KeepMessagesDuration;
import org.thoughtcrimedual.securesms.keyvalue.SignalStore;
import org.thoughtcrimedual.securesms.logging.CustomSignalProtocolLogger;
import org.thoughtcrimedual.securesms.logging.PersistentLogger;
import org.thoughtcrimedual.securesms.messageprocessingalarm.RoutineMessageFetchReceiver;
import org.thoughtcrimedual.securesms.messages.GroupSendEndorsementInternalNotifier;
import org.thoughtcrimedual.securesms.migrations.ApplicationMigrations;
import org.thoughtcrimedual.securesms.mms.SignalGlideComponents;
import org.thoughtcrimedual.securesms.mms.SignalGlideModule;
...
import org.thoughtcrimedual.securesms.registration.util.RegistrationUtil;
import org.thoughtcrimedual.securesms.ringrtc.RingRtcLogger;
import org.thoughtcrimedual.securesms.service.AnalyzeDatabaseAlarmListener;
import org.thoughtcrimedual.securesms.service.DirectoryRefreshListener;
import org.thoughtcrimedual.securesms.service.KeyCachingService;
import org.thoughtcrimedual.securesms.service.LocalBackupListener;
import org.thoughtcrimedual.securesms.service.MessageBackupListener;
import org.thoughtcrimedual.securesms.service.RotateSenderCertificateListener;
import org.thoughtcrimedual.securesms.service.RotateSignedPreKeyListener;
import org.thoughtcrimedual.securesms.service.webrtc.ActiveCallManager;
import org.thoughtcrimedual.securesms.service.webrtc.AndroidTelecomUtil;
...
import org.thoughtcrimedual.securesms.util.SignalUncaughtExceptionHandler;
import org.thoughtcrimedual.securesms.util.TextSecurePreferences;
import org.thoughtcrimedual.securesms.util.Util;
import org.thoughtcrimedual.securesms.util.VersionTracker;
import org.thoughtcrimedual.securesms.util.dynamiclanguage.DynamicLanguageContextWrapper;
