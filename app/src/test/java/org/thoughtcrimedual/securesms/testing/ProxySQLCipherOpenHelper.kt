package org.thoughtcrimedual.securesms.testing
...
class ProxySQLCipherOpenHelper(
  ...
  override val signalReadableDatabase: org.thoughtcrimedual.securesms.database.SQLiteDatabase
    get() = ProxySignalSQLiteDatabase(readableDatabase)

  override val signalWritableDatabase: org.thoughtcrimedual.securesms.database.SQLiteDatabase
