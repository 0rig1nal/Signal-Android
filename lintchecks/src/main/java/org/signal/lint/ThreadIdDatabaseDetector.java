...
public final class ThreadIdDatabaseDetector extends Detector implements SourceCodeScanner {
  ...
  private static final Set<String> EXEMPTED_CLASSES = new HashSet<>() {{
    add("org.thoughtcrimedual.securesms.database.ThreadDatabase");
  }};
  ...
  public UElementHandler createUastHandler(@NotNull JavaContext context) {
    return new UElementHandler() {
      ...
      public void visitClass(@NotNull UClass node) {
        ...
        boolean implementsReference = Arrays.stream(node.getInterfaces()).anyMatch(i -> "org.thoughtcrimedual.securesms.database.ThreadIdDatabaseReference".equals(i.getQualifiedName()));
